  ...
  return (
    <aside className="lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)]">
      <div className="rounded-[2rem] border border-[#b07e33]/20 bg-[#061A17] p-5 text-white shadow-xl shadow-[#061A17]/10">
        ...
        <p className="mt-3 text-sm leading-6 text-[#E6D6BD]">JSON content editor plus Supabase quote request inbox.</p>
        <div className="mt-4 flex flex-wrap gap-2">
          <AdminStatusBadge status="active">Protected</AdminStatusBadge>
          <AdminStatusBadge status="mock">JSON content</AdminStatusBadge>
        </div>
