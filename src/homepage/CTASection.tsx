...
export function CTASection() {
  ...
  return (
    <section className="bg-white px-4 py-20 sm:px-6 lg:px-8">
      <ParallaxLayer depth={8} scaleDepth={0.004} perspective className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-slate-950 p-8 text-white shadow-2xl shadow-slate-950/20 sm:p-12">
        <div className="relative">
          <ParallaxLayer depth={-7} className="absolute -right-24 -top-24 h-56 w-56 rounded-full bg-[#d7b56d]/20 blur-3xl" />
          <ParallaxLayer depth={5} className="absolute -bottom-28 left-1/3 h-48 w-48 rounded-full bg-white/10 blur-3xl" />
