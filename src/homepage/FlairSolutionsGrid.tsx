...
export function FlairSolutionsGrid() {
  ...
  return (
    <section id="solutions" className="bg-[#F7F1E6] px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <SectionHeader eyebrow="Setup • fittings • resets" title={section.title} subtitle={section.subtitle} />
