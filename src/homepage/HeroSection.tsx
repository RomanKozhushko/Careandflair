...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-950 text-white">
      <ParallaxLayer depth={-14} className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(215,181,109,0.24),transparent_30%),radial-gradient(circle_at_80%_20%,rgba(255,255,255,0.12),transparent_25%)]" />
