            ...
            <div className="mt-5 grid gap-8 lg:grid-cols-[0.9fr_0.7fr] lg:items-end">
              ...
              <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                <div className="rounded-3xl border border-[#b07e33]/20 bg-white/[0.045] p-5">
                  ...
                  <p className="mt-1 text-sm text-[#E6D6BD]">JSON-managed visual cases</p>
                </div>
                <div className="rounded-3xl border border-[#b07e33]/20 bg-white/[0.045] p-5">
                  <p className="text-3xl font-bold text-white">{featuredCount}</p>
                  <p className="mt-1 text-sm text-[#E6D6BD]">Featured proof blocks</p>
                </div>
                <div className="rounded-3xl border border-[#b07e33]/20 bg-white/[0.045] p-5">
                  <p className="text-3xl font-bold text-white">0</p>
                  <p className="mt-1 text-sm text-[#E6D6BD]">Hardcoded media paths in components</p>
                </div>
              </div>
            </div>
          </div>
